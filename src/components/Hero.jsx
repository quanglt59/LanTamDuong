...
<div className="relative group mt-6 sm:mt-8 pt-4 border-t-2 border-nature-green-200/30 animate-slide-in-bottom animation-delay-600">
  ...
  {/* Nội dung chính - XUỐNG DÒNG CHO MOBILE */}
  <div className="relative flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2 sm:gap-3 text-sm sm:text-base md:text-lg">
    
    {/* Dòng 1: Chủ động sức khỏe hôm nay */}
    <div className="flex flex-wrap items-center gap-2">
      {/* Icon nhảy */}
      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-nature-green-500 animate-bounce flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <span className="relative group/word1">
        ...
        <span className="relative font-bold text-transparent bg-clip-text bg-gradient-to-r from-nature-green-700 via-nature-green-500 to-nature-green-700 animate-gradient-x bg-[length:200%_auto] text-base sm:text-lg">
          CHỦ ĐỘNG
        </span>
      </span>
      
      <span className="text-nature-green-600 font-semibold animate-pulse-slow text-sm sm:text-base">
        sức khỏe
      </span>
      
      <span className="text-nature-green-600 font-semibold text-sm sm:text-base">
        hôm nay,
      </span>
    </div>
    
    {/* Dấu cách - ẩn trên mobile, hiện trên desktop */}
    <span className="hidden sm:block w-2 h-2 bg-nature-green-400 rounded-full animate-spin-slow flex-shrink-0"></span>
    
    {/* Dòng 2: Thịnh vượng cuộc sống ngày mai */}
    <div className="flex flex-wrap items-center gap-2">
      {/* Chữ "THỊNH VƯỢNG" */}
      <span className="relative group/word2">
        ...
        <span className="relative font-bold text-transparent bg-clip-text bg-gradient-to-r from-earth-700 via-earth-500 to-earth-700 animate-gradient-x animation-delay-500 bg-[length:200%_auto] text-base sm:text-lg">
          THỊNH VƯỢNG
        </span>
      </span>
      
      <span className="text-earth-600 font-semibold animate-pulse-slow animation-delay-300 text-sm sm:text-base">
        cuộc sống
      </span>
      
      <span className="text-earth-600 font-semibold text-sm sm:text-base">
        ngày mai
      </span>
      
      {/* Icon mũi tên */}
      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-nature-green-400 animate-slide-left flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
